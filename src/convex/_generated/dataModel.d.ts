...
export type DataModel = {
  callParticipants: {
    ...
    indexes: {
      ...
      by_user_left: ["userId", "leftAt", "_creationTime"];
    };
    searchIndexes: {};
    vectorIndexes: {};
  };
  ...
  rateLimits: {
    ...
    fieldPaths:
      "_creationTime" | "_id" | "count" | "resetAt" | "scope" | "userId";
    indexes: {
      by_id: ["_id"];
      by_creation_time: ["_creationTime"];
      by_reset: ["resetAt", "_creationTime"];
  ...
  statuses: {
    ...
    indexes: {
      ...
      by_storage: ["storageId", "_creationTime"];
      by_user: ["userId", "_creationTime"];
      by_user_client: ["userId", "clientPostId", "_creationTime"];
    };
    searchIndexes: {};
    vectorIndexes: {};
  };
